...
public class KafkaConfig {
    ...
    @Bean
    public ReceiverOptions<String, NotificationDTO> receiverOptions() {
        ReceiverOptions<String, NotificationDTO> receiverOptions = ReceiverOptions
    ...
    @Bean
    public KafkaReceiver<String, NotificationDTO> receiver(ReceiverOptions<String, NotificationDTO> receiverOptions) {
